...
export const mildang = {
  ...
  brand: {
    bg: {
      low: { value: { base: '{colors.mildangPT.light.100}', _dark: '{colors.mildangPT.dark.100}' } },
      base: { value: { base: '{colors.mildangPT.light.200}', _dark: '{colors.mildangPT.dark.400}' } },
      high: { value: { base: '{colors.mildangPT.light.300}', _dark: '{colors.mildangPT.dark.300}' } },
      highest: { value: { base: '{colors.mildangPT.light.400}', _dark: '{colors.mildangPT.dark.200}' } },
    },
    border: {
      low: { value: { base: '{colors.mildangPT.light.400}', _dark: '{colors.mildangPT.dark.200}' } },
      base: { value: { base: '{colors.mildangPT.light.500}', _dark: '{colors.mildangPT.dark.500}' } },
      high: { value: { base: '{colors.mildangPT.light.600}', _dark: '{colors.mildangPT.dark.600}' } },
      highest: { value: { base: '{colors.mildangPT.light.700}', _dark: '{colors.mildangPT.dark.900}' } },
    },
    fg: {
      low: { value: { base: '{colors.mildangPT.light.600}', _dark: '{colors.mildangPT.dark.600}' } },
      base: { value: { base: '{colors.mildangPT.light.700}', _dark: '{colors.mildangPT.dark.900}' } },
    },
    ghostBg: {
      base: { value: { base: '{colors.mildangPT.light.a100}', _dark: '{colors.mildangPT.dark.a100}' } },
      high: { value: { base: '{colors.mildangPT.light.a200}', _dark: '{colors.mildangPT.dark.a200}' } },
      highest: { value: { base: '{colors.mildangPT.light.a300}', _dark: '{colors.mildangPT.dark.a300}' } },
    },
    text: {
      base: { value: { base: '{colors.mildangPT.light.1000}', _dark: '{colors.mildangPT.dark.1000}' } },
    },
  },
} as const;
